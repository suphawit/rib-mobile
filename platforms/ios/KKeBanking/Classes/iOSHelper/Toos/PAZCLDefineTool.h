...
#ifndef PAFaceDetectionController_ZCLDefineTool_h
#define PAFaceDetectionController_ZCLDefineTool_h

#define kFaceImage(name)   [UIImage imageNamed:[NSString stringWithFormat:@"Demo.bundle/%@", name]]
#define kFaceFilePath(path,type)   [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"Demo.bundle/%@", path] ofType:type]
...
#define MAXIOS6      (kIOSVersions<=6.0 ? YES : NO)
...
// color
#define PAColorWithRGB(R, G, B, A) [UIColor colorWithRed:R/255.0f green:G/255.0f blue:B/255.0f alpha:A]

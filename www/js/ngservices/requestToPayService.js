angular.module('service.requestToPayService', [])
.factory('requestToPayService', function($q,invokeService,mainSession,kkconst,popupService,displayUIService,generalService) {
        ...
        createUIDataBinding: function(data){
            ...
            angular.forEach(data, function(value, key) {
                ...
                var dataObj = {
                    ...
                    expiryDate: displayUIService.convertDateNoTimeForUI(value['expiryDate']),

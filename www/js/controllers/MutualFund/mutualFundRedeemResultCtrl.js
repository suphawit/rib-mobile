angular.module('ctrl.mutualFundRedeemResult', [])
    .controller('mutualFundRedeemResultCtrl', function ($scope, popupService, mutualFundService, $ionicModal, displayUIService, cordovadevice, $interval, $ionicPlatform) {
        ...
        var CONSTANT_RECEIPT_MUTUALFUND_MODAL = 'templates/MutualFund/Redeem/mutualFundRedeemReceipt.html';
        ...
        function init() {
            ...
            if ($scope.fundResultInfo.unit !== null) {
